...
:::note[Remember]
A **relation** can be viewed as a **table**. The table contains any number of **rows**/**tuples**, and also has an associated **heading** which describes the **attributes** of the tuples. A relation *can not* contain any duplicate tuples.
:::
