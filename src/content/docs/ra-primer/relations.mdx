...
Here we have two entities (*Employee* and *Organization*) and one relation (*works for*). However, this idea of a relation does not correspond to relations in relational algebra.
