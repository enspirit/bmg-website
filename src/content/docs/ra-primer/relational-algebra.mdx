...
```ruby
my_friends2 = my_friends
  .rename(:name => :name1, :years_known => :years_known1)
your_friends2 = your_friends
  .rename(:name => :name2, :years_known => :years_known2)
my_friends2
  .cross_product(your_friends2)
